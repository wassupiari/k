...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
	    ...
	    // Definire una lista di colonne valide
	    List<String> validColumns = Arrays.asList("ID_PRODOTTO", "NOME", "DESCRIZIONE", "PREZZO", 
	                                              "QUANTITA", "PIATTAFORMA", "IVA", "DATA_USCITA", 
	                                              "IN_VENDITA", "IMMAGINE", "GENERE", "DESCRIZIONE_DETTAGLIATA");

	    if (order != null && !order.equals("")) {
	        // Verifica che l'ordine sia in colonne valide
	        if (validColumns.contains(order.toUpperCase())) {
